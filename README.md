...
<br>
<p>🔥 <b>小红书链接提取/作品采集工具</b>：提取账号发布、收藏、点赞、专辑post_link；提取搜索结果post_link、用户链接；采集小红书作品信息；提取小红书作品media_urls；下载小红书无水印作品文件！</p>
<p>⭐ 本项目完全免费开源，无任何收费功能，请勿上当受骗！</p>
<h1>📑 项目功能</h1>
<ul><b>程序功能</b>
<li>✅ 采集小红书作品信息</li>
<li>✅ 提取小红书作品media_urls</li>
<li>✅ 下载小红书无水印作品文件</li>
...
<li>✅ 下载小红书无水印作品文件</li>
<li>✅ 提取发现页面post_link</li>
<li>✅ 提取账号发布post_link</li>
<li>✅ 提取账号收藏post_link</li>
<li>✅ 提取账号点赞post_link</li>
<li>✅ 提取账号专辑post_link</li>
<li>✅ 提取搜索结果post_link</li>
<li>✅ 提取搜索结果用户链接</li>
</ul>
...
<h1>🔗 支持链接</h1>
<ul>
<li><code>https://www.xiaohongshu.com/explore/post_id?xsec_token=XXX</code></li>
<li><code>https://www.xiaohongshu.com/discovery/item/post_id?xsec_token=XXX</code></li>
<li><code>https://xhslink.com/分享码</code></li>
<br/>
<p><b>支持单次输入多个post_link，链接之间使用空格分隔；程序会自动提取有效链接，无需额外处理！</b></p>
</ul>
<h1>🪟 关于终端</h1>
...
<td align="center">小红书post_link，自动提取，不支持多链接；必需参数</td>
...
<h1>📜 其他说明</h1>
<ul>
<li>由于post_link携带日期信息，使用先前日期获取的post_link可能会被风控，建议下载作品文件时使用最新获取的post_link</li>
...
<p>提示：使用 XHS-Downloader 用户脚本批量提取post_link，搭配 XHS-Downloader 程序可以实现批量下载无水印作品文件！</p>
<h2>📜 脚本说明</h2>
<ul>
<li>下载小红书无水印作品文件时，脚本需要花费时间处理文件，请等待片刻，切勿多次点击下载按钮</li>
<li>无水印图片文件为 PNG 格式；无水印视频文件较大，可能需要较长的时间处理，页面跳转可能会导致下载失败</li>
<li>提取账号发布、收藏、点赞、专辑post_link时，脚本可以自动滚动页面直至加载全部作品，默认滚动检测间隔：2.5 秒</li>
<li>提取发现post_link、搜索作品、用户链接时，脚本可以自动滚动页面加载更多内容，默认滚动页面次数：10 次</li>
...
async def example():
    ...
    name_format = "post_title post_desc"
...
<td align="center">str</td>
<td align="center">作品文件名称格式，字段之间使用空格分隔，支持字段：<code>收藏数量</code>、<code>评论数量</code>、<code>分享数量</code>、<code>点赞数量</code>、<code>作品标签</code>、<code>post_id</code>、<code>post_title</code>、<code>post_desc</code>、<code>post_type</code>、<code>发布时间</code>、<code>最后更新时间</code>、<code>作者昵称</code>、<code>作者ID</code></td>
<td align="center"><code>发布时间 作者昵称 post_title</code></td>
</tr>
<tr>
